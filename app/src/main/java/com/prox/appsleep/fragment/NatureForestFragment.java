...
public class NatureForestFragment extends Fragment implements OnItemClickListener {
    ...
    private NestedScrollView bottomRemote;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_nature_forest, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        rcvItemRain = view.findViewById(R.id.rcvItemForest);
        ...
        categoryIconViewModel.getCategoryIconForest().observe(requireActivity(), new Observer<List<CategoryIconModel>>() {
            @Override
