...
public class CityFragment extends Fragment implements OnItemClickListener {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        rcvItemRain = view.findViewById(R.id.rcvItemCity);
        ...
        categoryIconViewModel.getCategoryIconCity().observe(requireActivity(), new Observer<List<CategoryIconModel>>() {
            @Override
