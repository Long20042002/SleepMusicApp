...
public class RelaxFragment extends Fragment implements OnItemClickListener {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        rcvItemRain = view.findViewById(R.id.rcvItemRelax);
        ...
        categoryIconViewModel.getCategoryIconRelax().observe(requireActivity(), new Observer<List<CategoryIconModel>>() {
            @Override
